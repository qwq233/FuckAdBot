...
func (s *hookedStore) ListPendingVerifications() ([]storepkg.PendingVerification, error) {
	if s.listPendingVerificationsHook != nil {
		return s.listPendingVerificationsHook()
	}
	return s.Store.ListPendingVerifications()
}
